...
\begin{enumerate}
  ...
  \item \textbf{Wang, H.}, Tang, L., Nishida, E., Fukano, Y., Kato, Y., Guo, W., 2023. Drone-based harvest data prediction can reduce on-farm food loss and improve farmer income. \textit{Plant Phenomics} 2023:5, 0086. \url{https://doi. org/10.34133/plantphenomics.0086}
...
\section*{Awards}
\begin{enumerate}
  \item \textbf{May 22, 2021}: Young researcher innovation award (若手研究者イノベーション賞), on Conference \textit{農業情報学会JSAI 2021年次大会}
  \item \textbf{October 2020 to March 2021}: Honors scholarship from \textit{Japan Student Service Organization}
\end{enumerate}
